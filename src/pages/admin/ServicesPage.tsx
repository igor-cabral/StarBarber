...
export function ServicesPage() {
  ...
  function reload() {
    listAllServices(profile.barbershop_id).then(setServices).catch((err) => setError(friendlyError(err, 'Não foi possível carregar os serviços. Tente novamente.')));
  }
  ...
  async function handleDelete(id: string) {
    ...
    try {
      ...
      alert(friendlyError(err, 'Não foi possível excluir este serviço.'));
    }
  }
