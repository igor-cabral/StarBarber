...
export function BarbersPage() {
  ...
  function reload() {
    listAllBarbers(profile.barbershop_id).then(setBarbers).catch((err) => setError(friendlyError(err, 'Não foi possível carregar os profissionais. Tente novamente.')));
  }
  ...
  async function handleDelete(id: string) {
    ...
    try {
      ...
      alert(friendlyError(err, 'Não foi possível remover este profissional.'));
    }
  }
